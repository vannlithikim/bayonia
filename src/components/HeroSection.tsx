...
function HeroSection() {
  ...
  return (
    <div className="relative flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 to-blue-50 h-screen w-full -mt-8">
      ...
      <div className="absolute inset-0 w-full h-full">
        <div className="relative w-full h-full">
          <Image
            ...
            fill
            className="object-cover scale-105 hover:scale-100 transition-transform duration-[8s] ease-out"
            priority
            quality={95}
          />
      ...
      <div className={`relative z-10 w-full max-w-6xl mx-4 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <div className="relative p-8 md:p-10">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-2">
              ...
              <div className="relative group">
                <div className={`relative transition-all duration-300 ${activeField === 'destination' ? 'transform scale-105' : ''}`}>
                  <div className="absolute inset-0 bg-white/10 rounded-2xl blur-sm group-hover:bg-white/20 transition-all duration-300" />
                  <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl p-4 border border-white/30 hover:border-white/50 transition-all duration-300 hover:shadow-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <input
                          ...
                          className="w-full bg-transparent text-gray-800 placeholder-gray-500 text-sm font-medium focus:outline-none"
                        />
                      </div>
                    </div>
                      ...
                      <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-xl shadow-2xl border border-gray-100 py-2 z-50 animate-in slide-in-from-top-2 duration-200">
                        {destinations.map((dest, index) => (
                          <button
                            ...
                            className="w-full text-left px-4 py-3 hover:bg-gray-50 text-sm text-gray-700 transition-colors duration-150"
                          >
                            {dest}
                          </button>
                        ))}
              ...
              {/* Check-in Date */}
              <div className="relative group">
                <div className={`relative transition-all duration-300 ${activeField === 'checkin' ? 'transform scale-105' : ''}`}>
                  <div className="absolute inset-0 bg-white/10 rounded-2xl blur-sm group-hover:bg-white/20 transition-all duration-300" />
                  <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl p-4 border border-white/30 hover:border-white/50 transition-all duration-300 hover:shadow-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <input
                          ...
                          className="w-full bg-transparent text-gray-800 text-sm font-medium focus:outline-none cursor-pointer"
              ...
              {/* Check-out Date */}
              <div className="relative group">
                <div className={`relative transition-all duration-300 ${activeField === 'checkout' ? 'transform scale-105' : ''}`}>
                  <div className="absolute inset-0 bg-white/10 rounded-2xl blur-sm group-hover:bg-white/20 transition-all duration-300" />
                  <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl p-4 border border-white/30 hover:border-white/50 transition-all duration-300 hover:shadow-lg">
                    <div className="flex items-center space-x-3">
              ...
              {/* Guests Field */}
              <div className="relative group">
                <div className={`relative transition-all duration-300 ${activeField === 'guests' ? 'transform scale-105' : ''}`}>
                  <div className="absolute inset-0 bg-white/10 rounded-2xl blur-sm group-hover:bg-white/20 transition-all duration-300" />
                  <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl p-4 border border-white/30 hover:border-white/50 transition-all duration-300 hover:shadow-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <button
                          ...
                          className="w-full text-left text-gray-800 text-sm font-medium focus:outline-none flex items-center justify-between"
                        >
                          <span>{formatGuestText()}</span>
                          <ChevronDown className={`h-4 w-4 transition-transform duration-200 ${activeField === 'guests' ? 'rotate-180' : ''}`} />
                        </button>
                      </div>
                    </div>
                      ...
                      <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-xl shadow-2xl border border-gray-100 p-4 z-50 animate-in slide-in-from-top-2 duration-200">
                        <div className="space-y-4">
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center space-x-3">
                              <button
                                onClick={() => setFormData({...formData, guests: {...formData.guests, adults: Math.max(1, formData.guests.adults - 1)}})}
                              ...
                              <button
                                onClick={() => setFormData({...formData, guests: {...formData.guests, adults: formData.guests.adults + 1}})}
                                className="w-8 h-8 rounded-full border border-gray-300 flex items-center justify-center hover:border-gray-400 transition-colors"
                              >
                                +
                              </button>
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center space-x-3">
                              <button
                                onClick={() => setFormData({...formData, guests: {...formData.guests, children: Math.max(0, formData.guests.children - 1)}})}
                                className="w-8 h-8 rounded-full border border-gray-300 flex items-center justify-center hover:border-gray-400 transition-colors"
                              >
                                -
                              </button>
                              ...
                              <button
                                onClick={() => setFormData({...formData, guests: {...formData.guests, children: formData.guests.children + 1}})}
                                className="w-8 h-8 rounded-full border border-gray-300 flex items-center justify-center hover:border-gray-400 transition-colors"
                              >
                                +
                              </button>
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center space-x-3">
                              <button
                                onClick={() => setFormData({...formData, guests: {...formData.guests, rooms: Math.max(1, formData.guests.rooms - 1)}})}
                                className="w-8 h-8 rounded-full border border-gray-300 flex items-center justify-center hover:border-gray-400 transition-colors"
                              >
                                -
                              </button>
                              <span className="w-8 text-center font-medium">{formData.guests.rooms}</span>
                              <button
                                onClick={() => setFormData({...formData, guests: {...formData.guests, rooms: formData.guests.rooms + 1}})}
                                className="w-8 h-8 rounded-full border border-gray-300 flex items-center justify-center hover:border-gray-400 transition-colors"
                              >
                                +
                              </button>
